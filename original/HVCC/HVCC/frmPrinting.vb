...
#Region "Transection area"
    Private Sub ShowPrint()
        ...
        Dim sb As New StringBuilder()
        sb.Remove(0, sb.Length)
        sb.Append("SELECT t1.Model,t1.Order,t0.CustomerPartNo,t0.CustomerPartNo2,t2.PartNo,t2.PartNoDetail,t1.LeakTest,t2.Quantity,t2.LotSize,t1.PrintID,t2.PartID,t0.CusID")
    ...
    Private Sub SavePrint()
        ...
        Dim sb As New StringBuilder()
        sb.Remove(0, sb.Length)
        sb.Append("INSERT INTO tbPrintLabel([PartNo],[CustomerNo],[Model],[Order],[LeakTest],[Counter],[Serial])")
        sb.Append(" Values (" & Val(cmbPartID.Text) & "," & Val(cmbCusID.Text) & ",'" & cmbModel.Text & "','" & cmbOrder.Text & "','" & txtLeakTest.Text & "','0','0000')")
